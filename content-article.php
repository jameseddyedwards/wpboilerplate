...
<section id="body-content">
	...
	<?php while (have_posts()) : the_post(); ?>
		...
		<article class="block">
			...
			<h2><?php the_field('wpboilerplate_sub_title'); ?></h2>

			<?php if (get_field('wpboilerplate_article_content')): ?>
 
				<?php while(has_sub_field('wpboilerplate_article_content')): ?>
					
					<div class="row">
						<?php the_sub_field('wpboilerplate_article_content_field'); ?>
					</div>
